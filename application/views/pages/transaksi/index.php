<main class="bg-gray-50 overflow-y-auto p-2 md:p-5">
    ...
    <div class="bg-white p-5 md:p-8 rounded-lg shadow-sm space-y-3">
        <div class="space-y-2">
            <h1 class="font-bold text-2xl">Form Transaksi</h1>
        ...
        <div>
            <form action="#" method="post">
                <div class="flex flex-col md:flex-row gap-5">
                    <div class="w-full md:w-w-1/3">
                        <div class="flex flex-col">
                            <label class="text-sm mb-1">ID Transaksi:</label>
                            <input type="text" value="TRX00236732878"
                    ...
                    <div class="w-full md:w-w-1/3">
                        <div class="flex flex-col">
                            ...
                            <input type="text" placeholder="IN20230513001"
                                class="border px-2 py-1 rounded-md text-gray-900 bg-gray-50 text-sm">
                        </div>
                    </div>
                    <div class="w-full md:w-w-1/3">
            ...
            <table id="transaction" class="table-tailwindcss w-full text-sm text-left text-gray-800">
                ...
                <tbody class="text-gray-700" id="result">
                    <tr class="bg-white border-b">
                        ...
                        <td class="flex flex-col gap-2 justify-center px-5 py-2">
                            <select class="product border px-2 py-1 rounded-md text-gray-900 bg-gray-50 text-sm"
                                name="states[]">
                                <option value="AL">Indomie Goreng</option>
                                <option value="WY">Sedap Goreng</option>
                            </select>
                            <div class="flex gap-2">
                                <select class="each border px-2 py-1 rounded-md text-gray-900 bg-gray-50 text-sm"
                                    name="states[]">
                        ...
                        <td class="px-6 py-2 space-y-1 md:space-y-1">
                            <button onclick="deleteItem(this)"
                                class="px-2 py-1 bg-red-500 hover:bg-red-600 rounded-md text-white"><i
                                    class="fa-solid fa-circle-xmark"></i></button>
                            <button onclick="addItem()"
                                class="px-2 py-1 bg-sky-500 hover:bg-sky-600 rounded-md text-white"><i
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-3 mt-3 border bg-gray-50 p-4 rounded-lg">
            ...
            <div class="flex gap-3">
                <button class="bg-gray-200 hover:bg-gray-300 px-3 py-2 rounded-lg"><i
                        class="fa-solid fa-print"></i></button>
                <button onclick="checkout()" class="bg-red-500 hover:bg-red-600 px-3 py-2 rounded-lg text-white"><i
                        class="fa-solid fa-cash-register"></i> Checkout</button>
            </div>
        </div>
    </div>
</main>
...
<script>
    ...
    <td class="px-6 py-2">BC001</td>
    <td class="flex flex-col gap-2 justify-center px-5 py-2">
      <select class="product border px-2 py-1 rounded-md text-gray-900 bg-gray-50 text-sm" name="states[]">
        <option value="AL">Indomie Goreng</option>
        <option value="WY">Sedap Goreng</option>
      </select>
      <div class="flex gap-2">
        <select class="each border px-2 py-1 rounded-md text-gray-900 bg-gray-50 text-sm" name="states[]">
          <option value="Merah">Merah</option>
          <option value="Biru">Biru</option>
        </select>
        <select class="each border px-2 py-1 rounded-md text-gray-900 bg-gray-50 text-sm" name="states[]">
